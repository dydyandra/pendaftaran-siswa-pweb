            ...
            <form action="proses-pendaftaran.php" method="POST">
                <div class="form-group mt-3 mx-2">
                    <p>
                        ...
                        <input class="a" type="text" name="nama" placeholder="Nama Lengkap" />
                    </p>
                </div>
                <div class="form-group mt-3 mx-2">
                    <p>
                        <label for="alamat">Alamat: </label>
                        <textarea class="a" name="alamat"></textarea>
                    </p>
                </div>
                <div class="form-group mt-3 mx-2">
                    <p>
                ...
                <div class="form-group mt-3 mx-2 my-4">
                    <p>
                        ...
                        <input class="a" type="text" name="sekolah_asal" placeholder="Nama Sekolah" />
                    </p>
                </div>
